...
public class PlanetsRouter {
    ...
    public RouterFunction<ServerResponse> route(PlanetsHandler PlanetsHandler) {
        ...
        return RouterFunctions
            ...
            .and(RequestPredicates.accept(MediaType.APPLICATION_JSON)), PlanetsHandler::listAll)

            .andRoute(RequestPredicates.GET("/planets/online/{page}")
            .and(RequestPredicates.accept(MediaType.APPLICATION_JSON)), PlanetsHandler::listByPage)

            .andRoute(RequestPredicates.POST("/planets/")
            .and(RequestPredicates.accept(MediaType.APPLICATION_JSON)), PlanetsHandler::save);
